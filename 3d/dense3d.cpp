...
template <class N>
Dense3d<N>::Dense3d(const string& p): KnlMat3d(p)
{
}
...
// ----------------------------------------------------------------------
template <class N>
int Dense3d<N>::setFromOptions(map<string,string>& opts)
{
  return 0;
}
...
// ----------------------------------------------------------------------
template <class N>
int Dense3d<N>::evaluate(const DblNumVec& srcDen, DblNumVec& trgVal) 
{
  //-----------------------------------
